        ...
        {domainError && (
          <div className="mb-6 bg-amber-50 border border-amber-200 p-4 rounded-2xl text-left animate-fade-up ring-4 ring-amber-50/50">
            ...
            <p className="text-[11px] text-slate-700 mb-3 leading-relaxed font-medium">
              Firebase memblokir domain <strong>{domainError}</strong>. Gunakan tombol <strong>Masuk sebagai Tamu</strong> di bawah untuk tetap menggunakan aplikasi.
            </p>
          </div>
        )}
        ...
        >
          {loading ? (
            ...
            <>
              ...
              {domainError ? "Domain Ditolak" : "Masuk dengan Google"}
            </>
          )}
        </button>
